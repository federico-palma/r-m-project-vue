  ...
  <section id="character-details">
    <div id="character-details-container" v-if="characterData">
      ...
      <ul id="character-details-list">
        <li class="character-details-item" :v-if="characterData.status">
          Status: {{ characterData.status }}
        </li>
        <li class="character-details-item" :v-if="characterData.gender">
          Gender: {{ characterData.gender }}
        </li>
        <li class="character-details-item" :v-if="characterData.species">
          Species: {{ characterData.species }}
        </li>
        <li class="character-details-item" :v-if="characterData.origin.name">
